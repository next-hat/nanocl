...
#[cfg(feature = "dev")]
pub const DNS_CONF: &str = include_str!("../../specs/controllers/dev.dns.yml");
#[cfg(feature = "release")]
pub const DNS_CONF: &str = include_str!("../../specs/controllers/dns.yml");
#[cfg(feature = "test")]
pub const DNS_CONF: &str = include_str!("../../specs/controllers/test.dns.yml");

pub async fn init(docker: &Docker) -> Result<(), CliError> {
  let proxy_conf =
    serde_yaml::from_str::<StateDeployment>(DNS_CONF).map_err(|err| {
      CliError {
